...
export default function Header() {
  return (
    <header
      className={`fixed relative top-0 z-40 md:pl-9 md:pt-14 md:pr-18 z-40 w-full ${styles.headerGlass}`}
        ...
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex items-center gap-2 text-sm text-slate-300">
            ...
            <Image
                ...
                priority={false}
            />
            <span className="truncate text-slate-200">Charger Management</span>
          </div>
        </div>
        <div className="flex min-w-0 items-center gap-3">
            <div className="mx-4 flex flex-1 items-center justify-center">
                <div className="flex w-full max-w-2xl items-center gap-3">
                    <div className="hidden sm:flex items-center gap-2">
                        <button
                            className="flex items-center gap-2 rounded-md border border-slate-700 bg-slate-800 px-5 py-2 text-sm text-slate-200 hover:bg-slate-700 gap-4"
                            aria-label="Vendor"
                            title="Vendor"
                        >
                            <span>Vendor</span>
                    ...
                    <div className="flex flex-1 items-center gap-2">
                        <div className="flex w-full items-center gap-2 rounded-md border border-slate-700 bg-slate-900 px-3 py-1">
                            <Image
                                src={Search}
                                alt="logo"
                                width={20}
                            ...
                            />
                            <select
                                className="hidden sm:inline-flex h-8 rounded-md px-2 text-sm text-slate-300"
                        ...
                        <button
                            className="hidden sm:inline-flex items-center gap-2 rounded-md border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-200 hover:bg-slate-700"
                            aria-label="Filter"
                            title="Filter"
                        >
                            <Image
